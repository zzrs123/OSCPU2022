...
事实上我对以上这些感受还是挺深刻的。因为去年我参加了一个机器人基地的考核，期间遇到了各种各样的麻烦，难免要询问有经验的学长，在网络上搜索相关的答案，试着看看各种各样的报错信息。在这个过程中，感觉真正地学着分析问题、解决问题。
...
又经过了快一年，这次一定要继续下去了，不然就毕业了。这期间又尝试了操作系统方面的内容，在debug的痛苦中对如何提问以及找到答案又有了更深刻的理解。
